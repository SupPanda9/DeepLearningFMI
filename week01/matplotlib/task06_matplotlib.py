...
def main():
    ...
    plt.text(1650, 70, 'India')
    plt.text(3100, 79, 'China')
...
if __name__ == "__main__":
    ...
    # have both low life expectancy and a low GDP per capita. - True

    # B. There is a negative correlation between GDP per 
    # capita and life expectancy. - False

    # C. China has both a lower GDP per capita and lower life
    # expectancy compared to India. - False